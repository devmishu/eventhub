...
export function EventCard({ imageSrc, title, location, category, date }: EventCardProps): React.JSX.Element {
  return (
    <Card 
      className="w-full bg-white border border-zinc-100/80 rounded-[24px] p-3 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] hover:shadow-[0_12px_24px_-8px_rgba(0,0,0,0.06)] transition-all duration-300 group flex flex-col !overflow-visible"
    >
      ...
      <div className="relative w-full aspect-[4/3] flex-shrink-0 !overflow-visible">
        ...
        <div className="w-full h-full rounded-[18px] overflow-hidden bg-zinc-100">
          <img
            ...
            onError={(e) => {
              e.currentTarget.src = "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=600&auto=format&fit=cover";
            }}
          />
        </div>
        
        {/* Floating Date Badge (Moved outside overflow-hidden wrapper) */}
