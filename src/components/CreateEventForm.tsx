          ...
          <div className="flex flex-col gap-5 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <TextField isRequired name="date" type="date">
                ...
                <Input className="w-full h-11 bg-white border border-zinc-200 rounded-xl px-3.5 text-sm font-medium text-zinc-800 focus-within:border-zinc-400 transition-all shadow-xs" />
              </TextField>
